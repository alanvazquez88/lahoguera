...
class Orders extends Admin_Controller
{
	...
	*/
	public function fetchOrdersData()
	{
		...
		foreach ($data as $key => $value) {
			...
			$store_data = $this->model_stores->getStoresDataforoders($value['store_id']);
	...
	*/
	public function create($table = null)
	{
		...
		if(isset($table)){
			echo "la mesa a utilizar es la : ".$table;
		}
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            // false case
            $this->data['table_data'] = $this->model_tables->getActiveTable($table);
